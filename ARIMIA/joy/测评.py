...
# 配置路径 - 请根据实际情况修改
MODEL_PATH = r'D:\Aa中工互联\工作安排\英格索兰\code\预测\lstm\sarima_results\sarima_model_30_weekday.pkl'  # 训练好的模型路径
TEST_DATA_PATH = r'D:\Aa中工互联\工作安排\英格索兰\code\预测\lstm\sarima_results\test_data.xlsx'  # 测试数据路径
