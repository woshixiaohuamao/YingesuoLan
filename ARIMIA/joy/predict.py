...
def get_recent_data(data, input_days, points_per_day):
    ...
    """
    # 计算需要的数据点数
    n_points = input_days * points_per_day # 确定模型输入的长度
...
if __name__ == "__main__":
    # 加载输入数据
    input_file = r'D:\Aa中工互联\工作安排\英格索兰\code\预测\lstm\sarima_results\train_data.xlsx'
    # model_path = r'D:\Aa中工互联\工作安排\英格索兰\code\预测\lstm\sarima_results\sarima_model.pkl'
    model_path = r'D:\Aa中工互联\工作安排\英格索兰\code\预测\lstm\sarima_results\best_sarima_model.pkl'
